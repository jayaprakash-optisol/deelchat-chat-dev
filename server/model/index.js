...
userDetail.hasOne(User, { as: 'userDetails', foreignKey: 'DN_USER_DETAILS' });
User.belongsTo(userDetail, { as: 'userDetails', foreignKey: 'DN_USER_DETAILS' });
...
User.hasMany(Notification, { as:'notificationSender' , foreignKey: 'NOTIFICATION_LOGS_Sender'});
Notification.belongsTo(User, { as:'notificationSender' , foreignKey: 'NOTIFICATION_LOGS_Sender'});
User.hasMany(Notification, { as:'notificationReceiver' , foreignKey: 'NOTIFICATION_LOGS_Receiver'});
Notification.belongsTo(User, { as:'notificationReceiver' , foreignKey: 'NOTIFICATION_LOGS_Receiver'});

Sync_contact.hasOne(MessageRecord, { as: 'userDetail', foreignKey: 'TMESSAGES_Record_UID' });
MessageRecord.belongsTo(Sync_contact, { as: 'userDetail', foreignKey: 'TMESSAGES_Record_UID' });
